                    ...
                    <Grid container spacing={0} justifyContent="space-around" alignItems="center" marginTop={20}>
                        <Grid item className="agendaBouton" onClick={setOrganisation}>
                            <Grid className="bouton">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="220" height="220" fill="currentColor" className="bi bi-calendar3" viewBox="0 0 16 16">
                        ...
                        <Grid item className="agendaBouton" onClick={setConsulter}>
                            <Grid className="bouton">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="220" height="220" fill="currentColor" className="bi bi-search" viewBox="0 0 16 16">
